#!/usr/bin/env python3
"""Run every tests/blender/test_*.py file inside headless Blender and report results.

Each test file already documents how to run itself individually::

    blender --background --factory-startup --python tests/blender/test_lifecycle.py

This script just does that for every test file in tests/blender/ and
...
TESTS_DIR = Path(__file__).resolve().parent / 'blender'
