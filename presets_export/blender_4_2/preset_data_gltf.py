presets_gltf = {
    "Godot-gltf": {
        ...
        "export_loglevel": -1,
        # Kept last: these didn't exist on the glTF exporter until later 4.x point releases
        # (gltfpack_kn/merge_animation/sampling_interpolation_fallback: 4.4+, vertex_color_name: 4.5+).
        # Blender's native preset loader (script.execute_preset) execs this file top to bottom and
        # aborts on the first unknown property, so keeping unsupported-on-old-versions keys at the
        # end means every earlier property still gets applied on 4.2/4.3/4.4 instead of being skipped.
        "export_gltfpack_kn": False,
        "export_merge_animation": 'ACTION',
        "export_sampling_interpolation_fallback": 'LINEAR',
        "export_vertex_color_name": 'Color',
    },
    "Godot-animation-gltf": {
        "filepath": '',
        "export_import_convert_lighting_mode": 'SPEC',
        "gltf_export_id": '',
        "export_use_gltfpack": False,
